...
export default function CardImg() {
    ...
    tablets:flex-row ">
            ...
            ">
                <div className="desktop:w-[350px]  desktop:h-[350px]
                laptop:w-[300px]  laptop:h-[300px]
...
dark:bg-slate-800">
                ...
                <div className="desktop:w-[350px] laptop:w-[300px]
...
dark:bg-slate-800">
                ...
                <div className="desktop:w-[350px] laptop:w-[300px]
                desktop:leading-[23px]  laptop:leading-[18px]
                border-2 rounded-[100px] ">
