...
export default function CardWebApp() {

    return (
        <section className='mb-[100px] bg-white rounded-card w-[852px] h-[609px] p-14 flex justify-between dark:bg-card-surface dark:border dark:border-slate-800'>
