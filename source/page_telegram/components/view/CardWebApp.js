...
export default function CardWebApp(props) {
    ...
    return (
        <section className='bg-white rounded-card w-[852px] h-[609px] p-14 flex justify-between dark:bg-card-surface dark:border dark:border-slate-800'>
            <div className='basis-[380px]'>
                <h3 className='font-bold text-[35px] leading-[32px] mb-10 dark:text-white'>&#9749; Кофейня</h3>
                <p className='text-justify text-sm leading-6 opacity-60 text-neutral-900 mb-20 dark:text-white'>
                ...
                <img src={WebAppOneQR}/>
                    <p className='text-[12px] opacity-60 text-neutral-900 w-[146px] dark:text-white'>Сканируйте QR-код или перейтите по ссылке, чтобы ознакомиться с тестовым приложением</p>
                </div>
            </div>
            <img src={WebAppOne}/>
        </section>
